            ...
            <main className=" animate-fade animate-duration-[2000ms]">
                ...
                <section className="">
                    <div className="flex max-lg:flex-col gap-10">
                        <motion.div
                            className="max-lg:m-auto lg:ml-auto flex flex-col gap-5 items-center justify-center"
                            variants={fadeLeft}
                            initial="hidden"
                            whileInView="visible"
                        ...
                        <motion.div
                            className=" px-6 max-lg:m-auto lg:mr-auto"
                            variants={fadeRight}
                            initial="hidden"
                            whileInView="visible"
                            ...
                            viewport={{ once: true }}
                        >
                            <NextImage src="/images/A.png" width={400} height={400} className="rounded shadow-2xl drop-shadow-2xl" alt="YanaPata" />
                        </motion.div>
                    </div>
                </section>
                        ...
                        <div className='w-full max-w-[1400px] py-5'>
                            <Accordion type="single" collapsible className="flex flex-col gap-10">
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                >
                                    <AccordionItem value="item-1" className="text-black shadow-lg border-black">
                                        ...
                                        <AccordionContent className="p-0">
                                            <div className='flex max-md:flex-col items-center justify-center p-8 filter saturate-200'>
                                                ...
                                                <div className='animate-fade-left animate-duration-[3000ms] md:w-1/2 flex items-center justify-center max-md:p-5 md:pr-14'>
                                                    <NextImage src="/images/about-img.webp" height={390} width={290} alt="Visión" />
                                                </div>
                                            </div>
                                        </AccordionContent>
                                    </AccordionItem>
                                ...
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                >
                                    <AccordionItem value="item-2" className="text-black shadow-lg border-black">
                                        <AccordionTrigger className="flex bg-slate-100 p-5 text-center text-2xl  hover:bg-slate-50 transform duration-300 hover:text-verde">
                                            Misión
                                        </AccordionTrigger>
                                        <AccordionContent className="p-0">
                                            <div className='flex max-md:flex-col-reverse items-center justify-center p-8 filter saturate-200'>
                                                <div className='animate-fade-right animate-duration-[3000ms] md:w-1/2 flex items-center justify-center max-md:p-5 md:pl-14'>
                                                    <NextImage src="/images/gato-vision1.webp" height={390} width={290} className='filter saturate-50 h-[390px] w-auto' alt="Misión" />
                                                </div>
                                ...
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                >
                                    <AccordionItem value="item-3" className="text-black shadow-lg border-black">
                                        <AccordionTrigger className="flex bg-slate-100 p-5 text-center text-2xl  hover:bg-slate-50 transform duration-300 hover:text-verde">
                                            Valores
                                        </AccordionTrigger>
