...
function page() {
  return (
    <>
      <Navbar/>
      <main>
          <PortadaDinamica  Titulo="Servicios" Descripcion="Dedicados a la salud y bienestar de tus mascotas, ofreciendo servicios de excelencia y cariño para que vivan una vida plena y saludable a tu lado." imgURL="/images/Servicio.jpg"/>
            <section className="">
