                ...
                <section className="w-full relative flex justify-center">
                    <div className="flex  max-xl:flex-col gap-10 md:p-10 w-full max-w-[1400px] items-center justify-center">
                        <div className=" flex flex-col  gap-10 p-5 max-md:w-full md:w-1/2" >
                            <motion.div
                                className="relative flex flex-col w-auto filter saturate-200"
                                variants={fadeLeft}
                                initial="hidden"
                                whileInView="visible"
                            ...
                            <motion.p
                                className="max-sm:text-base text-xl"
                                variants={fadeLeft}
                                initial="hidden"
                                whileInView="visible"
                        ...
                        <motion.div
                            className="max-md:w-full md:w-1/2 max-xl:order-first flex items-center justify-center p-5"
                            variants={fadeRight}
                            initial="hidden"
                            whileInView="visible"
