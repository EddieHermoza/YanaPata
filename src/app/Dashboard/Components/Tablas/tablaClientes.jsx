    ...
    <>
      <table className="w-full h-auto text-center text-xs">
            ...
            <tr>
                ...
                <th scope="col" className="p-3 max-md:hidden truncate max-w-[200px]">Telefono</th>
            ...
            <tr key={usuario.id} className="border-b hover:bg-slate-100 transform duration-200 h-[30px]">
                ...
                <td className="p-2 max-md:hidden truncate max-w-[200px]">{usuario.cliente.telefono}</td>
