...
function PortadaDinamica({titulo,desc,img}) {
  ...
  return (
    <>
        <section className=" relative min-h-[calc(100svh-200px)] w-full bg-stone-950 bg-fixed  bg-center bg-cover bg-no-repeat " id="SectPortada" style={backgroundStyle}>
            ...
            <div className="absolute w-full h-full items-center justify-center inset-0 flex flex-col gap-3">
                <h2 className={`text-white max-sm:text-4xl text-5xl lg:text-6xl xl:text-7xl text-center shadow-black text-shadow-lg  ${effectTittle}`}>{titulo}</h2>
